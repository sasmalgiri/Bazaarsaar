...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/auth/signup`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${BASE_URL}/morning-checklist`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.6 },
  ];
}
